"""
Tests for C:\Q2O_Combined\Tenant_Projects\build-a-farmers-registration-mobile-app\src\rest_api.py
...
try:
    ...
    pytest.skip(f"Could not import rest_api, skipping tests", allow_module_level=True)
...
class TestRestApi:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, RestApi)
