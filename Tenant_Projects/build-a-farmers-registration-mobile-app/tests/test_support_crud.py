"""
Tests for C:\Q2O_Combined\Tenant_Projects\build-a-farmers-registration-mobile-app\src\support_crud.py
...
try:
    from support_crud import SupportCrud
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import support_crud, skipping tests", allow_module_level=True)
...
class TestSupportCrud:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, SupportCrud)
