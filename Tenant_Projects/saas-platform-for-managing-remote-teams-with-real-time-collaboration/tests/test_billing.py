"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams-with-real-time-collaboration\api/app\billing.py
...
try:
    ...
    pytest.skip(f"Could not import billing, skipping tests", allow_module_level=True)
