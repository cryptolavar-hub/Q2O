"""
Tests for src/migrate_zoho_to_odoo_via_api.py
...
try:
    from migrate_zoho_to_odoo_via_api import MigrateZohoToOdooViaApi
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import migrate_zoho_to_odoo_via_api, skipping tests", allow_module_level=True)
...
def instance():
    ...
    if MODULE_AVAILABLE:
        return MigrateZohoToOdooViaApi()
    return None


class TestMigrateZohoToOdooViaApi:
    """
    Test cases for Migrate Zoho to Odoo via API
    """
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, MigrateZohoToOdooViaApi)
