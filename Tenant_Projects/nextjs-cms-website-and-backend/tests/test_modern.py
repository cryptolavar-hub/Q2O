"""
Tests for C:\Q2O_Combined\Tenant_Projects\nextjs-cms-website-and-backend\api/app\modern.py
...
try:
    ...
    pytest.skip(f"Could not import modern, skipping tests", allow_module_level=True)
...
class TestModern:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, Modern)
