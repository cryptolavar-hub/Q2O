"""
Tests for C:\Q2O_Combined\Tenant_Projects\nextjs-cms-website-and-backend\api/app\videos.py
...
try:
    ...
    pytest.skip(f"Could not import videos, skipping tests", allow_module_level=True)
...
class TestVideos:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, Videos)
