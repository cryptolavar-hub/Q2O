"""
Tests for C:\Q2O_Combined\Tenant_Projects\nextjs-cms-website-and-backend\api/app\cms_crud.py
...
try:
    from cms_crud import CmsCrud
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import cms_crud, skipping tests", allow_module_level=True)
...
class TestCmsCrud:
    """
    Test cases for with a CMS backend for full CRUD blog
    """
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, CmsCrud)
