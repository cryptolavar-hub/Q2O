"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\chat.py
...
try:
    ...
    pytest.skip(f"Could not import chat, skipping tests", allow_module_level=True)
