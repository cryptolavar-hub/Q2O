"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\drawers.py
...
try:
    ...
    pytest.skip(f"Could not import drawers, skipping tests", allow_module_level=True)
...
class TestDrawers:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, Drawers)
