"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\onedrive.py
...
try:
    ...
    pytest.skip(f"Could not import onedrive, skipping tests", allow_module_level=True)
...
class TestOnedrive:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, Onedrive)
