"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\github.py
...
try:
    ...
    pytest.skip(f"Could not import github, skipping tests", allow_module_level=True)
