"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\usage_stats.py
...
try:
    ...
    pytest.skip(f"Could not import usage_stats, skipping tests", allow_module_level=True)
...
class TestUsageStats:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, UsageStats)
