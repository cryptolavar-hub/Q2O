"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\kpi_metrics.py
...
try:
    ...
    pytest.skip(f"Could not import kpi_metrics, skipping tests", allow_module_level=True)
...
class TestKpiMetrics:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, KpiMetrics)
