"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\auth_sso.py
...
try:
    from auth_sso import AuthSso
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import auth_sso, skipping tests", allow_module_level=True)
...
class TestAuthSso:
    """
    Test cases for * Auth system (JWT, refresh tokens, SSO).
    """
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, AuthSso)
