"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\dockerfiles.py
...
try:
    from dockerfiles import Dockerfiles
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import dockerfiles, skipping tests", allow_module_level=True)
...
class TestDockerfiles:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, Dockerfiles)
