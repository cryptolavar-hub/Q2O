"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\output_format_format_output.py
...
try:
    from output_format_format_output import OutputFormatFormatOutput
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import output_format_format_output, skipping tests", allow_module_level=True)
...
def instance():
    ...
    if MODULE_AVAILABLE:
        return OutputFormatFormatOutput()
    return None


class TestOutputFormatFormatOutput:
    """
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, OutputFormatFormatOutput)
