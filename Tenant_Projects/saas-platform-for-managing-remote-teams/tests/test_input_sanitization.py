"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\input_sanitization.py
...
try:
    from input_sanitization import InputSanitization
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import input_sanitization, skipping tests", allow_module_level=True)
...
class TestInputSanitization:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, InputSanitization)
