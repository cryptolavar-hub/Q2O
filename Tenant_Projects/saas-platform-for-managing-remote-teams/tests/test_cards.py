"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\cards.py
...
try:
    ...
    pytest.skip(f"Could not import cards, skipping tests", allow_module_level=True)
