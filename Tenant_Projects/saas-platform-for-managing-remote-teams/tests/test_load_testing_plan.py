"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\load_testing_plan.py
...
try:
    from load_testing_plan import LoadTestingPlan
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import load_testing_plan, skipping tests", allow_module_level=True)
...
def instance():
    ...
    if MODULE_AVAILABLE:
        return LoadTestingPlan()
    return None


class TestLoadTestingPlan:
    """
    Test cases for * Load testing plan
    """
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, LoadTestingPlan)
