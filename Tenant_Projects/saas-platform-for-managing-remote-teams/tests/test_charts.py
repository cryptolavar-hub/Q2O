"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\charts.py
...
try:
    ...
    pytest.skip(f"Could not import charts, skipping tests", allow_module_level=True)
...
class TestCharts:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, Charts)
