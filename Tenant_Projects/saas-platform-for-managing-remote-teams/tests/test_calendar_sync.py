"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\calendar_sync.py
...
try:
    ...
    pytest.skip(f"Could not import calendar_sync, skipping tests", allow_module_level=True)
...
class TestCalendarSync:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, CalendarSync)
