"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\voice_video_calling.py
...
try:
    from voice_video_calling import VoiceVideoCalling
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import voice_video_calling, skipping tests", allow_module_level=True)
...
def instance():
    ...
    if MODULE_AVAILABLE:
        return VoiceVideoCalling()
    return None


class TestVoiceVideoCalling:
    """
    Test cases for * Voice and video calling (WebRTC).
    """
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, VoiceVideoCalling)
