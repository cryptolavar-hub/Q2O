"""
Tests for C:\Q2O_Combined\Tenant_Projects\saas-platform-for-managing-remote-teams\api/app\slack.py
...
try:
    ...
    pytest.skip(f"Could not import slack, skipping tests", allow_module_level=True)
...
class TestSlack:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, Slack)
