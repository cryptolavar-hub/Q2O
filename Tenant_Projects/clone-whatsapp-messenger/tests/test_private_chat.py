"""
Tests for C:\Q2O_Combined\Tenant_Projects\clone-whatsapp-messenger\src\private_chat.py
...
try:
    ...
    pytest.skip(f"Could not import private_chat, skipping tests", allow_module_level=True)
...
class TestPrivateChat:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, PrivateChat)
