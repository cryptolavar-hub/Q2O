"""
Tests for C:\Q2O_Combined\Tenant_Projects\instant-messenger-app\src\group_chat.py
...
try:
    ...
    pytest.skip(f"Could not import group_chat, skipping tests", allow_module_level=True)
