"""
Tests for C:\Q2O_Combined\Tenant_Projects\whatsapp-clone-messaging-app\src/groups.py
...
try:
    ...
    pytest.skip(f"Could not import groups, skipping tests", allow_module_level=True)
