"""
Tests for C:\Q2O_Combined\Tenant_Projects\whatsapp-clone-messaging-app\src/chat_basic_features.py
...
try:
    from chat_basic_features import ChatBasicFeatures
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import chat_basic_features, skipping tests", allow_module_level=True)
...
def instance():
    ...
    if MODULE_AVAILABLE:
        return ChatBasicFeatures()
    return None


class TestChatBasicFeatures:
    """
    Test cases for with basic Chat features
    """
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, ChatBasicFeatures)
