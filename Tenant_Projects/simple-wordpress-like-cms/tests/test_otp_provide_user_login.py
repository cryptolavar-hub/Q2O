"""
Tests for C:\Q2O_Combined\Tenant_Projects\simple-wordpress-like-cms\src\otp_provide_user_login.py
...
try:
    from otp_provide_user_login import OtpProvideUserLogin
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import otp_provide_user_login, skipping tests", allow_module_level=True)
...
def instance():
    ...
    if MODULE_AVAILABLE:
        return OtpProvideUserLogin()
    return None


class TestOtpProvideUserLogin:
    """
    Test cases for provide user OTP login
    """
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, OtpProvideUserLogin)
