"""
Tests for src/next.js_frontend.py
...
try:
    from next.js_frontend import Next.jsFrontend
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import next.js_frontend, skipping tests", allow_module_level=True)
...
def instance():
    ...
    if MODULE_AVAILABLE:
        return Next.jsFrontend()
    return None


class TestNext.jsFrontend:
    """
    Test cases for Next.js frontend
    """
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, Next.jsFrontend)
