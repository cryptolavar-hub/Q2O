"""
Tests for src/odoo_v18_integration.py
...
try:
    from odoo_v18_integration import OdooV18Integration
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import odoo_v18_integration, skipping tests", allow_module_level=True)
...
def instance():
    ...
    if MODULE_AVAILABLE:
        return OdooV18Integration()
    return None


class TestOdooV18Integration:
    """
    Test cases for Odoo v18 integration
    """
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, OdooV18Integration)
