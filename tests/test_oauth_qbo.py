"""
Tests for .\api\app\oauth_qbo.py
...
try:
    from oauth_qbo import OauthQbo
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import oauth_qbo, skipping tests", allow_module_level=True)
...
class TestOauthQbo:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, OauthQbo)
