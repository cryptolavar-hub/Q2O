"""
Tests for src/oauth_authentication.py
...
try:
    ...
    pytest.skip(f"Could not import oauth_authentication, skipping tests", allow_module_level=True)
...
class TestOauthAuthentication:
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, OauthAuthentication)
