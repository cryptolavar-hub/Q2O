"""
Tests for src/onboarding_wizard_ui.py
...
try:
    from onboarding_wizard_ui import OnboardingWizardUi
    MODULE_AVAILABLE = True
except ImportError:
    pytest.skip(f"Could not import onboarding_wizard_ui, skipping tests", allow_module_level=True)
...
def instance():
    ...
    if MODULE_AVAILABLE:
        return OnboardingWizardUi()
    return None


class TestOnboardingWizardUi:
    """
    Test cases for Onboarding wizard UI
    """
    ...
    def test_initialization(self, instance):
        ...
        assert isinstance(instance, OnboardingWizardUi)
